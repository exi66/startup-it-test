            ...
            <div class="container">
                ...
                <div class="collapse navbar-collapse" id="navbarNav">
                    <ul class="navbar-nav">
                        ...
                        <li class="nav-item">
                            <a class="nav-link active" href="{{ route('tag.list') }}">Теги</a>
                        </li>
                        <li class="nav-item">
                    ...
                    <ul class="list-group mb-4">
                        ...
                        <li class="list-group-item list-group-item-action d-flex justify-content-between">
                            ...
                            <span class="text-nowrap">
								...
								{!! Form::open(['method' => 'DELETE','route' => ['tag.destroy', $tag->id],'style'=>'display:inline', 'onsubmit'=>'return confirm("Удалить?");']) !!}
