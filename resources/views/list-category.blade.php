            ...
            <div class="container">
                ...
                <div class="collapse navbar-collapse" id="navbarNav">
                    <ul class="navbar-nav">
                        ...
                        <li class="nav-item">
                            <a class="nav-link active" href="{{ route('category.list') }}">Категории</a>
                        </li>
                    </ul>
                </div>
            </div>
                    ...
                    <ul class="list-group mb-4">
                        ...
                        <li class="list-group-item list-group-item-action d-flex justify-content-between">
                            ...
                            <span class="text-nowrap">
								...
								{!! Form::open(['method' => 'DELETE','route' => ['category.destroy', $category->id],'style'=>'display:inline', 'onsubmit'=>'return confirm("Удалить?");']) !!}
